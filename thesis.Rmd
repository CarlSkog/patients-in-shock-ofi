...
```
## Key results
We found that the most common type of OFI is clinical judgement error across almost all shock severities and there is only statistical significant association between severe shock with a BE of < -10 and OFI. 
