...
There were a total of `r nrow(merged.data)` patients in the trauma registry. Out of these, `r nrow(study.sample)` patients had been reviewed for the presence of opportunities for improvement. After exluding patients younger than 15 and/or were dead on arrival, `r nrow(study.sample)` patients remained. A total of X patients were finally excluded due to missing data, leaving us with Y patients for the final analysis.
...
Sample characteristics are presented in Table \@ref(tab:sample-characteristics). A total of `r ofi` patients had at least one opportunity for improvement. The median age was `r age`. Most patients were male `r gender`.
