...
To qualify into the trauma registry, requires admission by trauma team activation or any admission with an Injury Severity Score (ISS) of more than nine. We included all patients in "SWETRAU" and "Problem" between 2014 and 2023  We excluded patients younger than 15 and/or were dead on arrival. 
...
Version 1,
Due to the newer versions of ATLS classifications lack actual numbers, we will be using simplified and numerical version approximated by Dunham et al[@dunham_comparison_2017].

Version 2,
Due to the newer versions of ATLS classifications lack actual numbers, we will be approximating the values to numbers. For HF... For BP
...
All available data in the trauma care quality database? will be included, regarding the studied variables.
