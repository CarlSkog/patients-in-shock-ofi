...
Trauma is a major global public health concern, especially impacting economically active populations. Effective management of trauma care is essential to improving outcomes for severe injuries.

kolla upp/skriva om i intro
  Varför trauma är viktigt
    Mortalitet för unga
  ...
  Klassifikationer av chock nivå
  ...
  Kliniskt för att förbättra omhändertagande används OFI
    Förklara vad OFI är för något
  Syfte: Korrelation mellan chock nivåer och OFI (Är det då antal OFI/chock nivåer som anses?)
    Vilka typer av OFI finns hos shockpatienter?
    Koppling mellan nivå av chock och sannolikhet till OFI.
    \textit{Var kommer specifika typer av OFI in?? Finns denna sorts data?
     Om det finns kan man då även lägga till i frågeställningen att man jämför hur OFI subkategorier skiljer sig mellan de olika chock nivåerna.} 
